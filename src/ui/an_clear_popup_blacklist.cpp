...
void ANClearPPBlacklistSettingNode::commit() {
    this->dispatchCommitted();
}

bool ANClearPPBlacklistSettingNode::hasUncommittedChanges() {
  return false;
}

bool ANClearPPBlacklistSettingNode::hasNonDefaultValue() {
  return false;
}

void ANClearPPBlacklistSettingNode::resetToDefault() { }

ANClearPPBlacklistSettingNode* ANClearPPBlacklistSettingNode::create(
  ANClearPPBlacklistSettingValue* value, float width) {
